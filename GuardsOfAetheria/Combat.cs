...
namespace GuardsOfAetheria
{
	class Combat
	{
		...
		public void LoadEntities()
		{
			...
			utility.CalculateWeaponStats(); //TODO: make it faster and have Player.Instance.WeaponStats or check for cheating?
	    ...
	    public void Fight(int attackerSlot, int defenderSlot, int attackType)
	    {
            ...
            {
                damageDealt = 1;
                Console.WriteLine(Name[attackerSlot] + "struck a glancing blow and dealt 1 damage!"); // TODO: wont say how much damage
            }
            else { Console.WriteLine(Name[attackerSlot] + "used a basic attack and dealt " + damageDealt + " damage!"); }
